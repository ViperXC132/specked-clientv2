...
public class ModsScreen extends Screen {
    ...
    public ModsScreen(Screen parent) {
        super(Text.literal("Mods & Features"));
        this.parent = parent;
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float partialTick) {
        ...
        drawCenteredTextShadow(context, this.textRenderer, "Modules", this.width / 2, 20, 0xFFFFFF);
        ...
        for (Feature feature : SpekedClient.getInstance().getFeatureManager().getFeatures()) {
            ...
            drawString(context, this.textRenderer, feature.getName() + ": " + status, 20, y, color);
            y += 12;
        }
    }
